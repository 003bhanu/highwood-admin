...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    icons: {
      'align': 'note-icon_2x-align',
      'alignCenter': 'note-icon_2x-align-center',
      'alignJustify': 'note-icon_2x-align-justify',
      'alignLeft': 'note-icon_2x-align-left',
      'alignRight': 'note-icon_2x-align-right',
      'rowBelow': 'note-icon_2x-row-below',
      'colBefore': 'note-icon_2x-col-before',
      'colAfter': 'note-icon_2x-col-after',
      'rowAbove': 'note-icon_2x-row-above',
      'rowRemove': 'note-icon_2x-row-remove',
      'colRemove': 'note-icon_2x-col-remove',
      'indent': 'note-icon_2x-align-indent',
      'outdent': 'note-icon_2x-align-outdent',
      'arrowsAlt': 'note-icon_2x-arrows-alt',
      'bold': 'note-icon_2x-bold',
      'caret': 'note-icon_2x-caret',
      'circle': 'note-icon_2x-circle',
      'close': 'note-icon_2x-close',
      'code': 'note-icon_2x-code',
      'eraser': 'note-icon_2x-eraser',
      'floatLeft': 'note-icon_2x-float-left',
      'floatRight': 'note-icon_2x-float-right',
      'font': 'note-icon_2x-font',
      'frame': 'note-icon_2x-frame',
      'italic': 'note-icon_2x-italic',
      'link': 'note-icon_2x-link',
      'unlink': 'note-icon_2x-chain-broken',
      'magic': 'note-icon_2x-magic',
      'menuCheck': 'note-icon_2x-menu-check',
      'minus': 'note-icon_2x-minus',
      'orderedlist': 'note-icon_2x-orderedlist',
      'pencil': 'note-icon_2x-pencil',
      'picture': 'note-icon_2x-picture',
      'question': 'note-icon_2x-question',
      'redo': 'note-icon_2x-redo',
      'rollback': 'note-icon_2x-rollback',
      'square': 'note-icon_2x-square',
      'strikethrough': 'note-icon_2x-strikethrough',
      'subscript': 'note-icon_2x-subscript',
      'superscript': 'note-icon_2x-superscript',
      'table': 'note-icon_2x-table',
      'textHeight': 'note-icon_2x-text-height',
      'trash': 'note-icon_2x-trash',
      'underline': 'note-icon_2x-underline',
      'undo': 'note-icon_2x-undo',
      'unorderedlist': 'note-icon_2x-unorderedlist',
      'video': 'note-icon_2x-video'
    }
  }
});
...
var statusbar = renderer["a" /* default */].create(['<output class="note-status-output" role="status" aria-live="polite"></output>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="resize">', '<div class="note-icon_2x-bar"></div>', '<div class="note-icon_2x-bar"></div>', '<div class="note-icon_2x-bar"></div>', '</div>', '</div>'].join(''));
...
var dropdownButton = function dropdownButton(opt, callback) {
  return buttonGroup([ui_button({
    className: 'dropdown-toggle',
    contents: opt.title + ' ' + icon('note-icon_2x-caret'),
    tooltip: opt.tooltip,
    data: {
      toggle: 'dropdown'
    }
...
var ui_colorDropdownButton = function colorDropdownButton(opt, type) {
  return buttonGroup({
    ...
    children: [ui_button({
      ...
      className: 'dropdown-toggle',
      contents: icon('note-icon_2x-caret'),
...
var dialog = renderer["a" /* default */].create('<div class="note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
  ...
  $node.html(['<div class="note-modal-content">', options.title ? '<div class="note-modal-header"><button type="button" class="close" aria-label="Close" aria-hidden="true"><i class="note-icon_2x-close"></i></button><h4 class="note-modal-title">' + options.title + '</h4></div>' : '', '<div class="note-modal-body">' + options.body + '</div>', options.footer ? '<div class="note-modal-footer">' + options.footer + '</div>' : '', '</div>'].join(''));
