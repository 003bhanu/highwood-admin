...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    StandardTheme.prototype.baseIconClass = 'fc-icon_2x';
    StandardTheme.prototype.iconClasses = {
        close: 'fc-icon_2x-x',
        prev: 'fc-icon_2x-chevron-left',
        next: 'fc-icon_2x-chevron-right',
        prevYear: 'fc-icon_2x-chevrons-left',
        nextYear: 'fc-icon_2x-chevrons-right',
    };
    StandardTheme.prototype.rtlIconClasses = {
        prev: 'fc-icon_2x-chevron-right',
        next: 'fc-icon_2x-chevron-left',
        prevYear: 'fc-icon_2x-chevrons-right',
        nextYear: 'fc-icon_2x-chevrons-left',
    };
    StandardTheme.prototype.iconOverrideOption = 'buttonIcons'; // TODO: make TS-friendly
    StandardTheme.prototype.iconOverrideCustomButtonOption = 'icon';
    StandardTheme.prototype.iconOverridePrefix = 'fc-icon_2x-';
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.computeFgSegPositionCss = function (seg) {
            ...
            if (shouldOverlap && seg.forwardPressure) {
                // add padding to the edge so that forward stacked events don't cover the resizer's icon_2x
                props[isRtl ? 'marginLeft' : 'marginRight'] = 10 * 2; // 10 is a guesstimate of the icon_2x's width
            }
