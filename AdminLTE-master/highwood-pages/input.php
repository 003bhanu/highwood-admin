                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2 col-sm-4 col-12">
                                                            <div class="info-box" style="box-shadow: none">
                                                                <span class="info-box-icon bg-gradient-olive"><i
                                                        ...
                                                        <div class="col-md-10 col-sm-8 col-12">
                                                            <div class="info-box" style="box-shadow: none">
                                                                ...
                                                                <button type="submit"
                                                                        class="btn btn-info font-weight-bold mr-1 text-uppercase">
                                                                    <i
                                                                            class="fas fa-arrow-down"></i> Load
                                                                </button>
                                                                <button type="submit"
                                                                        class="btn btn-danger font-weight-bold mr-1 text-uppercase">
                                                                    <i
                                                                                            ...
                                                                                            <td>
                                                                                                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                                                                                                    ...
                                                                                                    <label class="custom-control-label font-weight-normal"
                                                                                                           for="customSwitch3">Loading..</label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                        ...
                                                        <div class="container-fluid">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="card card-primary">
                                                                        <div class="card-header">
                                                                            <h3 class="card-title text-uppercase"><b>All
                                                                                    material data</b></h3>
                                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card card-primary" style="box-shadow: none">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="title">Route Desc</label>
                                                        <input class="form-control" id="title" type="text"
                                                               placeholder="Eg: Kaluthara-Horana ">
                                                    </div>
                                                    <div class="card-footer">
                                                        <button type="submit" class="btn btn-primary">Submit</button>
                                                    </div>
